<?php $__env->startSection('title', 'Contacto - Sistema de Combate a Burlas Digitais'); ?>
            ...
            <div class="card h-100">
                <div class="card-body p-4">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <a href="<?php echo e(route('mapa')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Herd/Fraude/resources/views/contato.blade.php ENDPATH**/ ?>