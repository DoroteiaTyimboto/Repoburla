        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <?php if(is_array($denuncia->evidencias) && count($denuncia->evidencias) > 0): ?>
                        <hr>
                        <h5 class="mb-3">Provas Anexadas</h5>
                        <div class="row g-3">
                            <?php $__currentLoopData = $denuncia->evidencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $evidencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <?php if($caminho): ?>
                                    <div class="col-md-6">
                                        <div class="border rounded p-3 h-100">
                                            <?php if($isImage): ?>
                                                <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($caminho)); ?>" alt="<?php echo e($nome); ?>" class="img-fluid rounded mb-2">
                                            <?php endif; ?>
                                            <?php if($isVideo): ?>
                                                <video class="w-100 rounded mb-2" controls preload="metadata">
                                                    <source src="<?php echo e(\Illuminate\Support\Facades\Storage::url($caminho)); ?>" type="<?php echo e($mime); ?>">
                                            ...
                                            <?php endif; ?>
                                            <div class="small fw-semibold text-break"><?php echo e($nome); ?></div>
                                            <a href="<?php echo e(\Illuminate\Support\Facades\Storage::url($caminho)); ?>" target="_blank" rel="noopener" class="btn btn-sm btn-outline-primary mt-2">
