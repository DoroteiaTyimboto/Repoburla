    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-4 mb-4">
                <h5 class="mb-3">
                    <i class="bi bi-shield-check"></i> RepoBurla
                </h5>
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="<?php echo e(route('home')); ?>" class="text-white-50 text-decoration-none">Início</a></li>
                    <li><a href="<?php echo e(route('denuncias.index')); ?>" class="text-white-50 text-decoration-none">Denúncias</a></li>
                    <li><a href="<?php echo e(route('cursos.index')); ?>" class="text-white-50 text-decoration-none">Cursos</a></li>
                    <li><a href="<?php echo e(route('testador.index')); ?>" class="text-white-50 text-decoration-none">Testador de Links</a></li>
                    <li><a href="<?php echo e(route('sobre')); ?>" class="text-white-50 text-decoration-none">Sobre</a></li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start text-white-50 small">
                © 2026 RepoBurla. Todos os direitos reservados por Doroteia Tyimboto.
            </div>
...
<?php /**PATH C:\Users\HP\Desktop\DR\Repoburla\resources\views/components/footer.blade.php ENDPATH**/ ?>