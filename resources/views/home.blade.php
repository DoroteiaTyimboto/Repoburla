...
@section('title', 'Início - Sistema de Combate a Burlas Digitais')
...
<div class="container py-5">
    ...
    <div class="row align-items-center mb-5" style="background: linear-gradient(135deg, #2c3e50 0%, #3498db 100%); border-radius: 12px; padding: 4rem 2rem; color: white;">
        <div class="col-lg-6">
            ...
            <div class="d-flex gap-3">
                ...
                <a href="{{ route('cursos.index') }}" class="btn btn-outline-light btn-lg">
        ...
        <div class="col-md-3 mb-4">
            <div class="card text-center" style="border-top: 4px solid #e74c3c;">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold" style="color: #e74c3c;">{{ $stats['totalDenuncias'] }}</h2>
                    <p class="text-muted">Resolvidas: {{ $stats['denunciasResolvidas'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="card text-center" style="border-top: 4px solid #27ae60;">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold" style="color: #27ae60;">{{ $stats['cursosDisponivel'] }}</h2>
        ...
        <div class="col-md-3 mb-4">
            <div class="card text-center" style="border-top: 4px solid #f39c12;">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold" style="color: #f39c12;">{{ $stats['linksTestados'] }}</h2>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">{{ \Illuminate\Support\Str::limit($curso->descricao, 100) }}</p>
                        <div class="mb-3">
    ...
    <div class="row mb-5">
        @forelse($ultimasDenuncias as $denuncia)
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text text-muted">{{ \Illuminate\Support\Str::limit($denuncia->descricao, 120) }}</p>
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">
                                <i class="bi bi-person"></i> {{ $denuncia->user->name }} | 
                                <i class="bi bi-calendar"></i> {{ $denuncia->created_at->format('d/m/Y') }}
                            </small>
                            <a href="{{ route('denuncias.show', $denuncia) }}" class="btn btn-sm btn-outline-primary">
                                Detalhes
                            </a>
                        </div>
                    </div>
    ...
    <div class="row mt-5 mb-5" style="background: linear-gradient(135deg, #3498db 0%, #2c3e50 100%); border-radius: 12px; padding: 3rem 2rem; color: white; text-align: center;">
        <div class="col-12">
            ...
            @auth
                <a href="{{ route('testador.index') }}" class="btn btn-light btn-lg">
